...
class AdamW(torch.optim.Optimizer):
    r"""Implements AdamW algorithm. This code is adapated from `PyTorch codebase <https://github.com/pytorch/pytorch/blob/v1.2.0/torch/optim/adamw.py>`__.
    ...
    def __init__(self, 
        ...
        super(AdamW, self).__init__(self.params, defaults)
